...
Note that for any changes to the setting in your Kotter app UDP config, you'll need to go to Tools > Admin > Config in your Kotter app and click the "Reset" button for the new settings to take effect.
